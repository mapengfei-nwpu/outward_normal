...
double out_normal(vector<double> &points,  vector<size_t> &triangles){
    ...
    for (int i=0; i<num_points; i++){
        ...
        double sum=0.0;
        sum += (points[i * 3 + 0] + (*out_normal)[i * 3 + 0]) * (points[i * 3 + 0] + (*out_normal)[i * 3 + 0]) ;
        sum += (points[i * 3 + 1] + (*out_normal)[i * 3 + 1]) * (points[i * 3 + 1] + (*out_normal)[i * 3 + 1]) ;
        sum += (points[i * 3 + 2] + (*out_normal)[i * 3 + 2]) * (points[i * 3 + 2] + (*out_normal)[i * 3 + 2]) ;
...
int main(){
	...
	{
		//cout << points[i * 3 + 0] << points[i * 3 + 1] << points[i * 3 + 2]<< endl;
        //cout << normal[i * 3 + 0] << normal[i * 3 + 1] << normal[i * 3 + 2]<< endl;
	}
    double *p = &(points[6]);
